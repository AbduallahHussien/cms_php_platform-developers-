...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('whatsapp_conversations_type')) {
        ...
        if (!Schema::hasTable('whatsapp_quick-replies')) {
        ...
        if (!Schema::hasTable('whatsapp_reportelements')) {
        ...
        if (!Schema::hasTable('whatsapp_reports')) {
        ...
        if (!Schema::hasTable('whatsapp_translations')) {
